...
public final class Board implements Serializable {
    ...
    public Board(int length) {
        ...
        boolean altGenerate = false;
        if (altGenerate) {
            System.out.println("Generate board with first to up, left");
        }
        for (int i = 0; i < length; i++) {
            ...
            if (altGenerate) {
                if (false) {
                    ...
                    dx = -1;
                    dy = 0;
                } else if (blankX == 0 && blankY < n - 1) { // going down
                    dx = 0;
                    dy = 1;
    ...
    public String toString() {
        String result = "";
        // String result = "d=" + depth + ",b=" + bound + ",D=" + distance + " ";
        for (int y = 0; y < NSQRT; y++) {
            for (int x = 0; x < NSQRT; x++) {
